...
public class RateLimiterFactory {
    ...
    public static RateLimiter createRateLimiter(Plan plan) {
        return createRateLimiter(plan.getDefaultStrategy(), plan.getMaxRequests(), plan.getWindowSizeSeconds() * 1000);
    }
