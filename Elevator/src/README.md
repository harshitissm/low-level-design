# models.Elevator System (LLD)

## Problem Statement

Design and implement an models.Elevator System that can handle multiple requests, move between floors, and manage direction and vendingMachineState efficiently.

---

## Requirements

- **Multiple models.Elevator:** The system manages multiple elevators.
...
- **models.Elevator:** Represents the elevator, manages its vendingMachineState, direction, and request queue.
...
- **Fields:** models.Elevator elevator
...
- **Add multiple elevators:** Create a list of `models.Elevator` objects and update the controller logic.
